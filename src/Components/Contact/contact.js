...
export default function Contact() {
  const socialLinks = [
    ...
    {
      name: 'Email',
      url: 'mailto:mohimsingla@gmail.com',
      icon: (
  ...
  return (
    ...
    >
      ...
      {/* Section Header */}
      <h1 className="text-center text-4xl sm:text-5xl text-white mb-8 sm:mb-12 font-cursive relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-14">
          ...
          <div className="flex-1 text-center lg:text-left flex flex-col items-center lg:items-start space-y-5">
            ...
            <p className="text-sm sm:text-base text-zinc-300 leading-relaxed text-justify max-w-2xl font-light">
              I am a hard-working, sincere, and warmhearted software engineer currently pursuing my Bachelor's at <strong className="text-[#efb10a] font-semibold">PEC, Chandigarh</strong>. 
              I aspire to contribute to the IT industry with scalable solutions and innovative code. I am adaptable to intense situations, take ownership of my actions, and bring a strong collaborative mindset to every team.
            </p>
            ...
            <div className="flex items-center gap-4 pt-2">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-11 h-11 rounded-full bg-zinc-900/90 border border-zinc-700/80 text-zinc-300 hover:text-[#efb10a] hover:border-[#efb10a] hover:bg-[#efb10a]/10 flex items-center justify-center transition-all duration-300 shadow-md hover:scale-110"
                >
                  {social.icon}
                </a>
              ))}
